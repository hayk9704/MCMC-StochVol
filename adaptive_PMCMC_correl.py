...
if __name__ == "__main__":
    ...
    stochvol.generate(mu = real_pars["mu"], phi = real_pars["phi"], sigma2_eta = real_pars["sigma2_eta"], T = 200, seed = None)
    y_gen = stochvol.ys
    h_gen = stochvol.hs
    values = PMCMC(ys = y_gen, N_mcmc = 5000, x_first = xstart(), s = 2.38**2/3, m_latent = 50, burnin = 2000, rho = 0)
