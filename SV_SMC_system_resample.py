...
def particles0(y_t, theta, m_latent):
    ...
    ancestor_indices = systematic_resample(norm_weights)
...
if __name__ == "__main__":
    SMC_rep = 200                       # number of SMC repetitions
    x = theta_to_x(mu = -0.86, sigma2_eta = 0.0225, phi = 0.86)
    stochvol.generate(mu = -0.86, phi = 0.98, sigma2_eta = 0.0225, T = 200, seed = 103)
    y_obs = stochvol.ys
